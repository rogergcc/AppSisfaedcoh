...
import com.kevinlap.sisfaedcoh.model.ResponseAccesorio;
import com.kevinlap.sisfaedcoh.utils.TicketView;
...
//    private static final String URL = "https://api.androidhive.info/barcodes/search.php?code=";
    ...
    private void searchBarcode(String barcode) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Constans.obtenerIp(getApplicationContext()) + Constans.BUSCARBARCODE+barcode, null,
    ...
    private void mostrarAccesorio(JSONObject response) {
        try {
            ...
            if (responseAccesorio != null) {
                ...
                Glide.with(this).load(Constans.obtenerIp(getApplicationContext()) +Constans.IMAGENES +responseAccesorio.getAccesorio().getImagen()).into(imgPoster);
